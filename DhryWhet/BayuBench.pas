//==============================================================================
// Unit name: BayuBench.pas
// Unit description: Contains Dhrystone and Whetstone benchmark classes
...
// ==== ====== ====== ==========================================================
// 0.50 032203 Van    Simple port of Bayu's code to classes. Introduced
//                    COSBI TStopWatch for all timing routines.
//==============================================================================

unit BayuBench;

uses
  SysUtils, Classes, COSBI_Common;
  
type
  TDhryWhet = class( TObject )
  private
    fStopWatch : TStopWatch;
  protected
  public
    function Dhrystone(NumberOfRuns: integer;
                       var TimeElapsedForEachCycle: extended): extended;
    function Whetstone(NumberOfRuns: integer;
                       var TimeElapsedForEachCycle: extended): extended;
    property StopWatch read fStopWatch write fStopWatch;
  end; // TDhrystone = class( TObject )
...
var
  ...
  (* Initializations *)
    ...
    li64_ElapsedTime := fStopWatch.StopTimer                             //+v1.0

    TimeElapsedForEachCycle := li64_ElapsedTime / NumberOfRuns;          // v1.0
