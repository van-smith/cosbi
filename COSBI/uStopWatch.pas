...
uses
  ...
  Dialogs, math, Registry, COSBI_Common, uWinRing0;
...
type
  ...
  public
    ...
    property  MSRDriver : TWinRing0 read fWinRing0 write fWinRing0;
  end; // TStopWatch
...
//    // =====================================================================
  begin
    ...
    if assigned( fWinRing0 ) then begin
      li64_StopTick := T64bitRegister( fWinRing0.Rdtsc( 0 ) ).AsInt64;
    end else begin
